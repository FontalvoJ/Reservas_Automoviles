            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="shadow p-4">
                        ...
                        <div class="mb-2">
                            <asp:DropDownList ID="ddl_ingreso" AutoPostBack="True" placeholder="Ingreso" class="form-control" DataTextField="Descripcion" DataValueField="PKCodigo" DataSourceID="SqlDataSourceIngreso" runat="server" OnSelectedIndexChanged="ddl_ingreso_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="mb-2">
                            <asp:TextBox ID="txt_ingreso" placeholder="Valor Ingreso" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        ...
                        <div class="mb-2">
                            <asp:Label ID="lbl_pasan" runat="server" Text="Pasan" class="form-control"></asp:Label>
                        </div>
